...
let AuthenticationService = class AuthenticationService {
    constructor(http) {
        this.http = http;
        this.client = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(null);
        this.tipoclient = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(null);
        this.client$ = this.client.asObservable();
        this.tipoclient$ = this.tipoclient.asObservable();
    }
    loggin(client, tipo) {
...
let DataService = class DataService {
    constructor() {
        this.ellibro = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(null);
        this.ellibro$ = this.ellibro.asObservable();
        this.acompaniante = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(null);
        this.acompaniante$ = this.acompaniante.asObservable();
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "EstudianteService": () => (/* binding */ EstudianteService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
...
let EstudianteService = class EstudianteService {
    constructor(http, wasa) {
        this.http = http;
        this.wasa = wasa;
        this.apiUrl = this.wasa.apiUrlGlobal + '/estudiante';
    }
    getEstudiantes() {
    ...
    getsearchEstudiantebydoc(documento) {
        return this.http.get(`${this.apiUrl}/searchdoc/${documento}`);
    }
    getsearchEstudiantebygrado(grado, seccion) {
...
EstudianteService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], EstudianteService);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "GradoService": () => (/* binding */ GradoService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _global_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./global.service */ 7465);
...
let GradoService = class GradoService {
    constructor(http, wasa) {
        this.http = http;
        this.wasa = wasa;
        this.apiUrl = this.wasa.apiUrlGlobal + '/grado';
    }
    getGrados() {
        return this.http.get(`${this.apiUrl}`);
    }
    ...
    updateGrado(id, updatedGrado) {
        return this.http.put(`${this.apiUrl}/update/${id}`, updatedGrado);
    }
};
GradoService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient },
    { type: _global_service__WEBPACK_IMPORTED_MODULE_0__.GlobalService }
];
GradoService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], GradoService);
...
/***/ 5683:
/*!*********************************************!*\
  !*** ./src/app/services/parrafo.service.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ParrafoService": () => (/* binding */ ParrafoService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _global_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./global.service */ 7465);
...
let ParrafoService = class ParrafoService {
    constructor(http, wasa) {
        this.http = http;
        this.wasa = wasa;
        this.apiUrl = this.wasa.apiUrlGlobal + '/parrafo';
    }
    getParrafos() {
        return this.http.get(`${this.apiUrl}`);
    }
    ...
    getsearchParrafobylibro(libro) {
        return this.http.get(`${this.apiUrl}/filter/libro/${libro}`);
    }
    getsearchParrafobylibroandtipo(tipo, libro) {
    ...
    updateParrafo(id, updatedParrafo) {
        return this.http.put(`${this.apiUrl}/update/${id}`, updatedParrafo);
    }
};
ParrafoService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient },
    { type: _global_service__WEBPACK_IMPORTED_MODULE_0__.GlobalService }
];
ParrafoService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], ParrafoService);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ProfesorService": () => (/* binding */ ProfesorService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _global_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./global.service */ 7465);
...
let ProfesorService = class ProfesorService {
    constructor(http, wasa) {
        this.http = http;
        this.wasa = wasa;
        this.apiUrl = this.wasa.apiUrlGlobal + '/profesor';
    }
    getProfesors() {
        return this.http.get(`${this.apiUrl}`);
    }
    getsearchProfesorbydoc(documento) {
        return this.http.get(`${this.apiUrl}/searchdoc/${documento}`);
    }
    getProfesor(id) {
        return this.http.get(`${this.apiUrl}/${id}`);
...
ProfesorService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], ProfesorService);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PublicacionService": () => (/* binding */ PublicacionService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _global_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./global.service */ 7465);
...
let PublicacionService = class PublicacionService {
    constructor(http, wasa) {
        this.http = http;
        this.wasa = wasa;
        this.apiUrl = this.wasa.apiUrlGlobal + '/publicacion';
    }
    getPublicacions() {
        return this.http.get(`${this.apiUrl}`);
    }
    ...
    updatePublicacion(id, updatedPublicacion) {
...
PublicacionService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], PublicacionService);
...
let ReporteService = class ReporteService {
    ...
    getstatisticsindividualdetail(estudiante, inicio, fin) {
    ...
    getstatisticsbygradeandsecccion(grado, seccion, inicio, fin) {
...
ReporteService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], ReporteService);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ResolucionService": () => (/* binding */ ResolucionService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _global_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./global.service */ 7465);
...
let ResolucionService = class ResolucionService {
    constructor(http, wasa) {
        this.http = http;
        this.wasa = wasa;
        this.apiUrl = this.wasa.apiUrlGlobal + '/resolucion';
    }
    getResolucions() {
        return this.http.get(`${this.apiUrl}`);
    }
    ...
    getResolucioncuestionario(codigo) {
        return this.http.get(`${this.apiUrl}/filterprogress/${codigo}`);
    }
    getResolucioncuestionarioeintento(codigo, intento) {
    ...
    // tslint:disable-next-line: no-shadowed-variable
    saveResolucion(resolucion) {
        return this.http.post(`${this.apiUrl}/create`, resolucion);
    }
    updateResolucion(id, updatedResolucion) {
        return this.http.put(`${this.apiUrl}/update/${id}`, updatedResolucion);
    }
};
ResolucionService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient },
    { type: _global_service__WEBPACK_IMPORTED_MODULE_0__.GlobalService }
];
ResolucionService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], ResolucionService);
...
/***/ 936:
/*!*************************************************!*\
  !*** ./src/app/services/responsable.service.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ResponsableService": () => (/* binding */ ResponsableService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _global_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./global.service */ 7465);
...
let ResponsableService = class ResponsableService {
    constructor(http, wasa) {
        this.http = http;
        this.wasa = wasa;
        this.apiUrl = this.wasa.apiUrlGlobal + '/responsable';
    }
    getResponsables() {
        return this.http.get(`${this.apiUrl}`);
    }
    ...
    getsearchResponsablebydoc(documento) {
        return this.http.get(`${this.apiUrl}/searchdoc/${documento}`);
    }
...
ResponsableService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient },
    { type: _global_service__WEBPACK_IMPORTED_MODULE_0__.GlobalService }
];
ResponsableService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], ResponsableService);
...
/***/ 1463:
/*!******************************************!*\
  !*** ./src/app/services/tipo.service.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TipoService": () => (/* binding */ TipoService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _global_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./global.service */ 7465);
...
let TipoService = class TipoService {
    constructor(http, wasa) {
        this.http = http;
        this.wasa = wasa;
        this.apiUrl = this.wasa.apiUrlGlobal + '/tipo';
    }
    getTipos() {
        return this.http.get(`${this.apiUrl}`);
    }
...
TipoService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient },
    { type: _global_service__WEBPACK_IMPORTED_MODULE_0__.GlobalService }
];
TipoService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], TipoService);
...
/* harmony export */ });
/* harmony import */ var D_universidad_universidad_semestre_5_cursos_extracurriculares_calidad_educativa_sistema_lectural_applectura_angular14_ionic6_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,D_universidad_universidad_semestre_5_cursos_extracurriculares_calidad_educativa_sistema_lectural_applectura_angular14_ionic6_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,D_universidad_universidad_semestre_5_cursos_extracurriculares_calidad_educativa_sistema_lectural_applectura_angular14_ionic6_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,D_universidad_universidad_semestre_5_cursos_extracurriculares_calidad_educativa_sistema_lectural_applectura_angular14_ionic6_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
